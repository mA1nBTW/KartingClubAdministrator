...
namespace KartingClubApp
{
    ...
    public partial class MainForm : Form
    {
        ...
        /// <summary>
        /// Обробляє натискання F1 для відображення довідки користувача.
        /// KeyPreview форми має бути встановлено у True.
        /// </summary>
        private void MainForm_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                MessageBox.Show(
                    "ДОВІДКА — Адміністратор картинг-клубу\n\n" +
                    "ГОНЩИКИ:\n" +
                    "- Додати гонщика — реєстрація нового клієнта\n" +
                    "- Редагувати — зміна даних обраного гонщика\n" +
                    "- Видалити (або клавіша Delete) — видалення гонщика\n" +
                    "- Рядок пошуку — фільтрація за прізвищем або ліцензією\n\n" +
                    "ЗАЇЗДИ:\n" +
                    "- Створити заїзд — формування нової гонки з учасниками\n" +
                    "- Відкрити заїзд (або Enter / подвійний клік) — " +
                    "внесення результатів або перегляд завершеного заїзду\n\n" +
                    "ФОРМАТИ ЧАСУ КОЛА:\n" +
